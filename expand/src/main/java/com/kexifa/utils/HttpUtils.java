...
public class HttpUtils {
    ...
    public static Response httpPut(String url, String authorization, Object o) throws IOException {

        OkHttpClient client = new OkHttpClient();

        MediaType mediaType = MediaType.parse("application/json");
        RequestBody body = RequestBody.create(mediaType, JSON.toJSON(o).toString());
    ...
    public static Response httpPost(String url, String authorization, Object o) throws IOException {
    ...
    public static Header[] getReturnHeader(String url, String ck) throws IOException {
        ...
        try {
            ...
            allHeaders = response.getHeaders("Set-Cookie");
            return allHeaders;
     ...
     */
    @SneakyThrows
    public static Response postXiaoTuAd(String url, String param) {
        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .addHeader("Host", "mapi.xiaotucc.com")
                .addHeader("Connection", "keep-alive")
                .addHeader("Content-Length", "91")
                .addHeader("content-type", "application/x-www-form-urlencoded")
                .addHeader("Accept-Encoding", "gzip,compress,br,deflate")
                .addHeader("User-Agent", "Mozilla/5.0 (iPhone; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.39(0x18002732) NetType/WIFI Language/zh_CN")
                .addHeader("Referer", "https://servicewechat.com/wxa3dde54e66082a1b/281/page-frame.html")
                .build();
     ...
     */
    @SneakyThrows
    public static Response postXiaoTuTake(String url, String param) {
        OkHttpClient client = new OkHttpClient();
    ...
    @SneakyThrows
    public static Response postElm(String url, String param, String cookie) {
        OkHttpClient client = new OkHttpClient();
        ...
        Request request = new Request.Builder()
                ...
                .addHeader("Content-type", "application/x-www-form-urlencoded")
                .addHeader("Origin", "https://tb.ele.me")
                .addHeader("Sec-Fetch-Site", "same-site")
                .addHeader("Sec-Fetch-Mode", "cors")
                .addHeader("Sec-Fetch-Dest", "empty")
                .addHeader("Referer", "https://tb.ele.me/wow/alsc/mod/3fe8408d9ba38d4726448a87?spm-pre=a2ogi.bx828379.0.0&spm=a13.b_activity_kb_m69301.0.0")
    ...
    @SneakyThrows
    public static Response postEnvElm(String url, String param, String cookie) {
        OkHttpClient client = new OkHttpClient();
    ...
    @SneakyThrows
    public static Response getElm(String url, String cookie) {
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url(url)
                .get()
                .addHeader("Host", "running-game.ele.me")
                .addHeader("User-Agent", "Rajax/1 Apple/iPhone13,2 iOS/15.7.1 Eleme/11.0.38 ID/C7EF5702-1F6C-4F04-A6B1-85227170CD02; IsJailbroken/0 Mozilla/5.0 (iPhone; CPU iPhone OS 15_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 AliApp(ELMC/11.0.38) UT4Aplus/ltracker-0.2.30.31 WindVane/8.7.2 1170x2532 PHA/2.0.0")
                .addHeader("Accept", "application/json, textain, */*")
                .addHeader("Accept-Language","zh-CN,zh;q=0.9")
                .addHeader("Connection", "Keep-Alive")
                .addHeader("Origin", "https://running-game.ele.me")
                .addHeader("Referer", "https://running-game.ele.me")
                .addHeader("X-Ttid", "201200@eleme_iphone_11.0.38")
                .addHeader("X-Ua", "RenderWay%2FH5%20AppName%2Felmc%20DeviceId%2FC7EF5702-1F6C-4F04-A6B1-85227170CD02%20AppExtraInfo%2F%7B%22miniWua%22%3A%22%22%2C%22umidToken%22%3A%22%22%2C%22ttid%22%3A201200%40eleme_iphone_11.0.38%2C%22deviceUUID%22%3A%22%22%2C%22utdid%22%3A%22%22%7D")
                .addHeader("cookie", cookie)
                .build();
        Response response = client.newCall(request).execute();
        System.out.println(response.body().string());
